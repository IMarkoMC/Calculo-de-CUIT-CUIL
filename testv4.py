...
if(systype != "Linux"):
    print("Este script nadamas funciona en cualquier sistema basado en LINUX")
    exit()

print("\x1b[0;33m Calculador de CUIT")


# FIXME: si el SO es windows finalizar el scrpit
...
def CalculateLastDigit():
    #Int usado para almacenar el resultado de la suma hecho con +=
    Sum = 0
